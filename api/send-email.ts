...
// Deploy: Vercel Functions (TypeScript)
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.log('📧 [Resend API] Recebido:', { nome, email, assunto, destinatarios })
    ...
    console.log('📧 [Resend API] Enviando email para:', destinatarios)

    // Preparar dados do email
    const emailData = {
      from: 'Repositório de Vagas <noreply@resend.dev>', // Usar domínio padrão do Resend
      to: destinatarios,
      replyTo: email,
...
Data: ${new Date().toLocaleString('pt-BR')}
    ...
    console.log('✅ [Resend API] Email enviado com sucesso:', result)
    ...
    console.error('❌ [Resend API] Erro ao enviar email:', error)
